...
Els resultats mostren diferències entre alguns valors proporcionats per les tires i els que apareixen a la pàgina web d’Aigües de Barcelona. A més, els valors que ens aporten són diferents, per tant, ens hem de limitar només als que coincideixen en ambdós casos
...
\hline
Nitrat & 0 & <1-10.2 & mg NO$_3^-$ /L & Molt lluny al valor oficial. \\
\hline
...
\hline
Fluorur & 0 & <0,2 & mg F$^-$ /L & No coincideix amb el valor esperat. \\
\hline
Crom (VI) & 0 & --- & mg/L & No present. \\
\hline
Plom & 0 & --- & mg/L & No detectat; adequat. \\
...
\hline
Nitrat & 0 & <1-10.2 & mg NO$_3^-$ /L & Molt lluny al valor oficial; com l'anterior cas. \\
\hline
Nitrit & 0 & ---& mg /L & Informació no proporcionada. \\
\hline
Clor total & 0 & --- & mg/L & Valor típic \\
...
Ferro & 0 & --- & mg/L & Adequat; no hauria de tenir. \\
\hline
Fluorur & 0 & <0,2 & mg F$^-$ /L & No coincideix amb el valor esperat; com l'anterior cas. \\
\hline
Crom (VI) & 0 & --- & mg/L & No present. \\
\hline
Plom & 0 & --- & mg/L & No detectat; adequat. \\
...
Àcid cianúric & 0 & --- & mg/L & No rellevant; igual que en l'experiment anterior. \\
\hline
Coure & 0.2 & --- & mg/L & Dins límits; com l'anterior cas. \\
\hline
Brom & 0 & --- & mg/L & No detectat en aquest cas. \\
\hline
Mercuri & 0 & --- & mg/L & No detectat; correcte. \\
...
\caption{Comparació entre els valors experimentals i els oficials de l'aigua del bar (sense exposició a gran cuantitat de llum}
\label{tab:comparacio_aigua_amb_llum}
\end{table}

Tal com podeu veure a les taules~\ref{tab:comparacio_aigua_sense_llum} i~\ref{tab:comparacio_aigua_amb_llum}, la mesura del pH, que en l’experiment anterior no havia coincidit amb cap de les dues tires, en aquest cas es troba dins dels valors esperats en ambdues. I no només això, sinó que també altres valors, com la duresa total, es van situar dins dels límits en totes dues tires.

És cert que molts paràmetres no els puc comparar per manca de dades oficials, però, gràcies als que sí que disposo, puc valorar fins a quin punt poden ser fiables els valors dels compostos restants. Aquesta comparació indirecta em permet fer-me una idea general de la coherència dels resultats.
