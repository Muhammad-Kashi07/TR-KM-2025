\chapter{Ampliació metodologia}
\label{a:metodologia_informàtica}

En aquest annex s’aprofundeix en alguns dels aspectes teòrics i tècnics  en la part informàtica de la metodologia. Tot i que en el capítol~\ref{c:Metodologia}:~\nameref{c:Metodologia} s’ha presentat una visió general, a continuació presentarem de manera més detallada les eines, sistemes i tecnologies utilitzades, amb l’objectiu de documentar de manera completa l’entorn de treball i les decisions tècniques adoptades.
